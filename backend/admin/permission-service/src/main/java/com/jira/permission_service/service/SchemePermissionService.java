...
public class SchemePermissionService {
    ...
    public SchemePermissionResponse updateSchemePermission(Integer Id, SchemePermissionRequest schemePermissionRequest) {
        SchemePermission schemePermission = schemePermissionRepository
                .findById(Id)
                .orElseThrow(() -> new AppException(ErrorCode.UNCATEGORIZED_EXCEPTION));
        schemePermission.setPermissionScope(schemePermission.getPermissionScope().equals(schemePermissionRequest.getPermissionScope()) ? schemePermission.getPermissionScope() : schemePermissionRequest.getPermissionScope());
        schemePermission.setPermissionParameter(schemePermission.getPermissionParameter().equals(schemePermissionRequest.getPermissionParameter()) ? schemePermission.getPermissionParameter() : schemePermissionRequest.getPermissionParameter());
        schemePermission.setPermissionKey(schemePermission.getPermissionKey().equals(schemePermissionRequest.getPermissionKey()) ? schemePermission.getPermissionKey() : schemePermissionRequest.getPermissionKey());
        schemePermission = schemePermissionRepository.save(schemePermission);
        return schemePermissionMapper.toSchemePermissionResponse(schemePermission);
    }
    ...
    public List<SchemePermissionResponse> getAllSchemePermissions() {
        ...
        return schemePermissions.stream().map(schemePermissionMapper::toSchemePermissionResponse).toList();
    }
