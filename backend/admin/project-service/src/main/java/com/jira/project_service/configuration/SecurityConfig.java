...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS_POST_ADMIN = { "/add/user" };
    private final String[] PUBLIC_ENDPOINTS_PUT_ADMIN = { "/roles/update/{id}" };
//    private final String[] PUBLIC_ENDPOINTS_GET_ADMIN = {"/"};
...
//    ProviderJwt providerJwt;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeHttpRequests(requests -> requests
                .requestMatchers(HttpMethod.POST, PUBLIC_ENDPOINTS_POST_ADMIN)
                .permitAll()
